...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Zenith Inc Wiki',
    description: 'Copyright and intellectual property information for Zenith Inc Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Zenith Inc Wiki',
      description: 'Copyright and intellectual property information for Zenith Inc Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Zenith Inc Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Zenith Inc Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Zenith Inc Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Peak Incrementals</strong> - Creators of the Zenith Inc game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Zenith Inc</strong> - Trademark of Peak Incrementals</li>
              <li><strong>Zenith Inc Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Zenith Inc Wiki.
            </p>
            ...
            <p>
              ...
              Zenith Inc Wiki<br />
              Email: <a href="mailto:dmca@zenith-inc.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@zenith-inc.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Zenith Inc Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Zenith Inc Wiki (zenith-inc.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@zenith-inc.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@zenith-inc.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@zenith-inc.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@zenith-inc.wiki</a>
            </p>
            <p>
