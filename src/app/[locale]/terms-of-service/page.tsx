...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Zenith Inc Wiki",
    description: "Read the Terms of Service for Zenith Inc Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Zenith Inc Wiki",
      description: "Terms and conditions for using Zenith Inc Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Zenith Inc Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Zenith Inc Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Zenith Inc Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Zenith Inc Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Zenith Inc". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Code lists and free reward guides</li>
              <li>Upgrade and tower progression guides</li>
              <li>Currency and economy information</li>
              <li>Prestige and rebirth strategy guides</li>
              <li>Update and patch walkthroughs</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Zenith Inc Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation (Roblox) or the official developers of Zenith Inc. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Zenith Inc Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation (Roblox) and/or the developers of Zenith Inc. We use such
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, ZENITH INC WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Zenith Inc Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@zenith-inc.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@zenith-inc.wiki</a>
            </p>
            <p>
